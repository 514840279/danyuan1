jQuery.extend({
    ...
    ajaxFileUpload: function (s) {
        ...
        var param = jQuery.extend(s.params,$.uniteToken(true));
        s = jQuery.extend({data: param}, jQuery.ajaxSettings, s);
    ...
    uploadHttpData: function (r, type) {
        ...
        if (type == "json") {
            ...
            var __k__ = data.uniteToken.k;
            var __token__ = data.uniteToken.token;

...
public class FtpTest {  
    ...
    @Test
    public void stream(){
    	FtpUseBean usebean = new FtpUseBean();
    	usebean.setHost("192.168.199.232");
    	usebean.setPort(21);
    	usebean.setUserName("wth");
    	usebean.setPassword("wth");
    	usebean.setFtpSeperator("WD");
    	usebean.setFtpPath("ftp.txt");
    	usebean.setRepeatTime(2);
    	FtpUtil ftp = new FtpUtil();
    	ftp.setFtpUseBean(usebean);
    	ftp.ftpLogin();
